// This Google Earth Engine Javascript code reduces and export MOD16A2.006 Terra Net Evapotranspiration 8-Day Globa time series in the appropiate format required for InVEST SWY
...
Map.addLayer(MODIS_ET.select(band_name).sum().divide(total_steps).multiply(factor).clip(basin),{min:800,max:2000,palette:['cyan','yellow','red']},band_name,true,1)

////////////////////////////////////

  var dataset = MODIS_ET;
