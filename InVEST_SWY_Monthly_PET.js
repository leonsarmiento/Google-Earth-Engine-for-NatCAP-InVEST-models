// This Google Earth Engine Javascript code reduces and export TerraClimate time series in the appropiate format required for InVEST SWY
...
Map.addLayer(TClimate.select(band_name).sum().divide(total_steps).multiply(factor).clip(basin),{min:3000,max:3600,palette:['cyan','yellow','red']},band_name,true,1)

////////////////////////////////////

  var dataset = TClimate;
